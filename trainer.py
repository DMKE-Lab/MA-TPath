    ...
    def train(self, sess):
        ...
        for episode in self.train_environment.get_episodes():
            ...
            for i in range(self.path_length):
                ...
                per_example_loss, per_example_logits, action_idx, tim_idx = sess.partial_run(h, [self.per_example_loss[i], self.per_example_logits[i], self.action_idx[i], self.tim_idx[i]],
